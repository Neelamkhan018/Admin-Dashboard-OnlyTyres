...
export default function TruckModelEdit() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate('/Truckmodel', { state: { brandid: state.brandid } }); // Redirect to the truck model list with brandid
    } catch (error) {
      console.error('Error updating truck model:', error);
      setError('Error updating truck model. Please try again later.');
    }
  };
