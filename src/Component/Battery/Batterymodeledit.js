...
//   useEffect(() => {
//     const fetchBatteryModelDetails = async () => {
//       try {
//         const response = await axios.get(`${url.nodeapipath}/get-batterymodel/${id}`);
...
//         setError('Error fetching battery model details. Please try again later.');
//       } finally {
//         setLoading(false);
//       }
//     };

//     fetchBatteryModelDetails();
//   }, [id]);
...
//     try {
//       const response = await axios.put(`${url.nodeapipath}/update-batterymodel/${id}`, formDataToSend, {
//         headers: {
...
//         navigate('/batterymodel'); // Redirect to the battery model list page
//       } else {
//         setError('Failed to update battery model');
//       }
//     } catch (error) {
//       console.error('Error updating battery model:', error);
//       setError('Error updating battery model. Please try again later.');
//     }
//   };
...
// export default BatteryModelEdit;
...
const BatteryModelEdit = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status === 200) {
        navigate('/batterymodel', { state: { brandid: state.brandid } }); // Redirect to the battery model list page
      } else {
        setError('Failed to update battery model');
      }
    } catch (error) {
