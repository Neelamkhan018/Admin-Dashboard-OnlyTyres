...
export default function BatteryBrandEdit() {
  const { id } = useParams(); 
  ...
  useEffect(() => {
    const fetchBatteryBrandDetails = async () => {
      try {
        const response = await axios.get(`${url.nodeapipath}/get-Batterybrand/${id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${url.nodeapipath}/Battery-update/${id}`, {
        method: 'PUT',
        body: formDataToSend, 
      });
          ...
          <div className="ec-content-wrapper">
            <div className="content">
              <div className="breadcrumb-wrapper breadcrumb-wrapper-2 breadcrumb-contacts">
                <h1>Edit Battery Brand</h1>
                <p className="breadcrumbs">
                  <span><a href="#">Home</a></span>
                  <span><i className="mdi mdi-chevron-right"></i></span>Edit Battery Brand
                </p>
              </div>
              <div className="row">
                    ...
                    <div className="card-body">
                      <div className="ec-cat-form ec-vendor-uploads">
                        ...
                        <form onSubmit={handleSubmit}>
                          ...
                          <div className="row">
                            <div className="col-12">
                              <button type="submit" className="btn btn-primary">Update Battery Brand</button>
                            </div>
                          </div>
                        </form>
                      </div>
