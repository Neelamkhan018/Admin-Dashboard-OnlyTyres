...
export default function AlloyWheelBrandEdit() {
  const { id } = useParams(); 
  ...
  useEffect(() => {
    const fetchAlloyWheelBrandDetails = async () => {
      try {
        const response = await axios.get(`${url.nodeapipath}/get-alloybrand/${id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${url.nodeapipath}/alloy-update/${id}`, {
        method: 'PUT',
        body: formDataToSend, 
      });
      ...
      navigate('/AlloyWheelbrand'); // Redirect to the alloy wheel brand list
    } catch (error) {
          ...
          <div className="ec-content-wrapper">
            <div className="content">
              <div className="breadcrumb-wrapper breadcrumb-wrapper-2 breadcrumb-contacts">
                <h1>Edit Alloy Wheel Brand</h1>
                <p className="breadcrumbs">
                  <span><a href="#">Home</a></span>
                  <span><i className="mdi mdi-chevron-right"></i></span>Edit Alloy Wheel Brand
                </p>
              </div>
              <div className="row">
                    ...
                    <div className="card-body">
                      <div className="ec-cat-form ec-vendor-uploads">
                        ...
                        <form onSubmit={handleSubmit}>
                          ...
                          <div className="row">
                            <div className="col-12">
                              <button type="submit" className="btn btn-primary">Update Alloy Wheel Brand</button>
                            </div>
                          </div>
                        </form>
                      </div>
