...
export default function AccessoriesBrandEdit() {
  const { id } = useParams(); 
  ...
  useEffect(() => {
    const fetchAccessoriesBrandDetails = async () => {
      try {
        const response = await axios.get(`${url.nodeapipath}/get-accessoriesbrand/${id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${url.nodeapipath}/update-accessoriesbrand/${id}`, {
        method: 'PUT',
        body: formDataToSend, 
      });
      ...
      navigate('/Accessoriesbrand'); // Redirect to the accessories brand list
    } catch (error) {
          ...
          <div className="ec-content-wrapper">
            <div className="content">
              <div className="breadcrumb-wrapper breadcrumb-wrapper-2 breadcrumb-contacts">
                <h1>Edit Accessories Brand</h1>
                <p className="breadcrumbs">
                  <span><a href="#">Home</a></span>
                  <span><i className="mdi mdi-chevron-right"></i></span>Edit Accessories Brand
                </p>
              </div>
              <div className="row">
                    ...
                    <div className="card-body">
                      <div className="ec-cat-form ec-vendor-uploads">
                        ...
                        <form onSubmit={handleSubmit}>
                          ...
                          <div className="row">
                            <div className="col-12">
                              <button type="submit" className="btn btn-primary">Update Accessories Brand</button>
                            </div>
                          </div>
                        </form>
                      </div>
