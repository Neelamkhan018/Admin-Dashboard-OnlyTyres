...
//     const [dealerProductCounts, setDealerProductCounts] = useState({});
...
//         try {
//             const response = await axios.get("http://localhost:8000/get-dealers");
//             setDealers(response.data.dealers || []);
//             calculateProductCounts(response.data.dealers || []);
...
//         try {
//             const response = await axios.get("http://localhost:8000/total-amount-per-dealer");
...
//     };
    ...
    //             try {
    //                 const response = await axios.get(`http://localhost:8000/get-store/${dealer._id}`);
...
//     const calculateProductCounts = (dealers) => {
//         const counts = {};
//         dealers.forEach(dealer => {
//             const dealerId = dealer._id;
//             const storedDealerLists = JSON.parse(localStorage.getItem("dealerLists")) || {};
//             counts[dealerId] = (storedDealerLists[dealerId] || []).length;
//         });
//         setDealerProductCounts(counts);
//     };
...
//                                                                 const productCount = dealerProductCounts[dealer._id] || 0;
